...
export const MathReasonerModel = (apiKey: string): RueterModel =>
    new RueterModel("grok", apiKey, 1, {
        temperature: 0,
        maxTokens: 512,
...
export const CriticModel = (apiKey: string): RueterModel =>
    new RueterModel("grok", apiKey, 1, {
        temperature: 0,
        maxTokens: 300,
...
export const FactCheckerModel = (apiKey: string): RueterModel =>
    new RueterModel("grok", apiKey, 1, {
        temperature: 0,
        maxTokens: 8,
